function Abhishekangal2() {
  ...
  return (
    <div className="p-10 space-y-40">
      <h2 className="text-[#FC931E] text-xl font-bold text-center">
      ...
      <div className="flex justify-center items-center">
        <div className="grid grid-cols-3 gap-x-80 gap-y-10 w-full">
          {abhishekangalData.map((item, index) => (
            <button
              key={index}
              className="p-5 bg-[#FC931E] text-white rounded-4xl text-lg font-bold"
            >
              {item}
            </button>
          ))}
