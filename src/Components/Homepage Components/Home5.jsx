  ...
  return (
    <div className="p-10 space-y-10">
      ...
      <div className="flex justify-center items-center">
        <h2 className="text-[#FC931E] text-lg lg:text-2xl font-extrabold">
      ...
      <div className="flex flex-col lg:flex-row space-y-3 lg:space-y-0 justify-between">
        <button onClick={() => navigate("/vazhipadu")} className="bg-[#FF8600] px-10 py-5 rounded-3xl text-base lg:text-2xl  font-bold cursor-pointer hover:bg-[#ff8800c9] transition duration-300">വഴിപാടുകൾക്കായി</button>
        <button onClick={() => navigate("/abhishekangal")} className="bg-[#FF8600] px-10 py-5 rounded-3xl text-base lg:text-2xl  font-bold cursor-pointer hover:bg-[#ff8800c9] transition duration-300">അഭിഷേകങ്ങൾക്കായി</button>
      </div>
    </div>
  );
}
